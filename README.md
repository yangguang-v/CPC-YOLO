...
![Fig. Supp-1 The representation of the Inner-PIoUv2 loss function. The area of the turquoise box represents the intersection between the target box and the anchor box, while the area of the orange box represents the intersection between the inner target box (after scaling by the scale factor ratio) and the inner anchor box.][scale=0.8](https://github.com/yangguang-v/CPC-YOLO-Lightweight-Framework-for-Small-Ship-Detection-in-SAR-Images/blob/main/Fig.Supp-1.png)
